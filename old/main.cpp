...
HWND go4help = NULL,switchL = NULL;
HDC subDC = NULL;
DWORD timeDL = 0;
BOOL bQuit = FALSE;
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow){
    ...
    Block(InitWindowComponets){
        ...
        switchL = CreateWindowEx(0,"BUTTON","SW",WS_CHILD | WS_VISIBLE,360,140,
                              40,30,subHWND,MENU(OPEN_HELP_PAGE),hInstance,NULL);
    ...
    if(!ofs.bad()){
        ofs << ts.Translate(ACCESS_TOKEN,"en_us").GetUTF8();
    }
    ofs.close();
    ...
    switch (uMsg)
    {
        ...
        case WM_COMMAND:
            ...
            case OPEN_LOADED_FILE:
                ...
                break;
            case OPEN_HELP_PAGE:{
                string command = "start data\\help_";
                command += ts.Translate(VERIFY_TOKEN,"en_us").GetGBK();
                command += ".html";
